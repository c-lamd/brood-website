  ...
  return (
    <div id="page" className="w-full justify-center min-h-screen mx-[25px] md:mx-[50px]">
      <main id="main" className="flex flex-col text-center decoration-none relative">
        <div className="flex flex-row text-nowrap text-left justify-between items-end w-[calc(100vw-50px)] leading-none text-[11vw] xl:text-[12vw] md:w-[calc(100vw-100px)] font-[family-name:var(--font-erotique-sans-bold)]">
          <h1 id="brand-title-left" >BROOD</h1>
          <h1 id="brand-title-right">COFFEE</h1>
        </div>
